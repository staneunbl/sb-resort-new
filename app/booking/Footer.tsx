        ...
        <footer className="bg-cstm-secondary flex-col flex w-screen">
                ...
                <div className="flex flex-col">
                    <Link href="/">
                        <div className="flex justify-start">
                            ...
                            <p className="text-white font-bold ml-2">ABC Resort</p>
                        </div>
                    </Link>
                </div>
                <div className="flex flex-col text-sm md:flex-row text-center gap-4 text-white/[.70]">
                    <Link href="#">About Us</Link>
                    <Link href="#">Privacy Policy</Link>
                    <Link href="#">Terms of Use</Link>
                    <Link href="#">Careers</Link>
                </div>
                <div className="flex gap-8 text-white/[.70] text-base">
                    <div className="size-4">
                        <Link href="#" className="transition hover:text-cstm-primary">
            ...
            <div className="p-4 flex justify-center">
                <div className="flex flex-col md:flex-row gap-2">
                    <p className="text-white/[.7] text-center">© 2024 ABC Resort.</p> 
