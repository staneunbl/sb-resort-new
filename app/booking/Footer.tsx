...
export function BookingFooter() {
    ...
    return (
        <footer className="bg-cstm-secondary flex-col flex w-screen">
            <div className="flex flex-col md:flex-row gap-8  items-center justify-between p-8">
                <div className="flex flex-col w-1/3">
                    ...
                    </Link>
                    {
                         ...
                         <div className="flex gap-4 ms-8 items-center"> 
                             {/* <MapPinIcon size={12} className="text-white"/> */}
                             <p className="text-white/[.70] text-sm">{config.CompanyAddress}</p>
                         </div>
                    }
                    {
                        ...
                        <div className="flex gap-4 ms-8 items-center"> 
                            ...
                            <p className="text-white/[.70] text-sm">{config.CompanyContact}</p>
                        </div>
                    }
                    {
                        config.CompanyEmail &&
                        <div className="flex gap-4 ms-8 items-center"> 
                            {/* <AtSignIcon size={12} className="text-white"/> */}
                            <p className="text-white/[.70] text-sm">{config.CompanyEmail}</p>
                        </div>
                    }
                </div>
                <div className="flex flex-col justify-center text-sm md:flex-row text-center gap-4 text-white/[.70] w-1/3">
                    <Link href="#">About Us</Link>
                    <Link href="#">Privacy Policy</Link>
                    <Link href="#">Terms of Use</Link>
                    <Link href="#">Careers</Link>
                </div>
                <div className="flex gap-8 text-white/[.70] text-base w-1/3 justify-end">
                    {   config.FacebookUrl &&
                        <div className="size-4 text-white">
                            <Link href={config.FacebookUrl} className="transition hover:text-cstm-primary">
                    ...
                    }
                    {
                        config.InstagramUrl &&
                        <div className="size-4 text-white">
                            <Link href={config.InstagramUrl} className="transition hover:text-cstm-primary">
                    ...
                    }
                    {
                        config.XUrl &&
                        <div className="size-4 text-white">
                            <Link href={config.XUrl} className="transition hover:text-cstm-primary">
                    ...
                    }
                    {
                        config.YoutubeUrl &&
                        <div className="size-4 text-white ">
                            <Link href={config.YoutubeUrl} className="transition hover:text-cstm-primary">
            ...
            <div className="p-4 flex justify-center">
                <div className="flex flex-col md:flex-row gap-2 text-sm">
                    <p className="text-white/[.7] text-center">© 2024 {config.CompanyName}.</p> 
                    <p className="text-white/[.7] text-center">All Rights Reserved.</p>
                </div>
            </div>
        </footer>
    )
