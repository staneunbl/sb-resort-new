...
export function DashboardCard({title, icon, count}: DashboardCardProps) {
    return (
        <div className="group/dashcard w-1/3 rounded-lg relative bg-cstm-primary">
            ...
            <div className="h-full overflow-hidden relative flex flex-col px-4 py-5 justify-between rounded-lg">
                ...
                <div className="flex flex-col gap-2 transition group-hover/dashcard:translate-x-1">
                    <p className="text-lg text-white/[.70] group-hover/dashcard:text-white">{title}</p>
                </div>

                <div className="transition group-hover/dashcard:translate-x-1 group-hover/dashcard:text-ctsm-primary ">
                    {count === undefined ? (
